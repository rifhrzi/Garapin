...
export class EscrowController {
  async create(req: Request, res: Response, next: NextFunction) {
    try {
      const result = await escrowService.create(req.body.projectId, req.user!.userId);
  ...
  async checkPaymentStatus(req: Request, res: Response, next: NextFunction) {
    try {
      const result = await escrowService.checkPaymentStatus(req.params.id as string, req.user!.userId);
  ...
  async release(req: Request, res: Response, next: NextFunction) {
    try {
      const result = await escrowService.release(req.params.id as string, req.user!.userId);
  ...
  async getEarnings(req: Request, res: Response, next: NextFunction) {
    try {
      const earnings = await escrowService.getFreelancerEarnings(req.user!.userId);
