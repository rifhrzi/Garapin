...
router.get('/conversations/:projectId', authenticate, validateUUID('projectId'), (req, res, next) =>
...
router.get('/messages/:conversationId', authenticate, validateUUID('conversationId'), (req, res, next) =>
